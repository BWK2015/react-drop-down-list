...
var Button = React.createClass({
    ...
    render: function () {
        return React.createElement(
            "button",
            { className: "btn " + this.props.className, type: "button", onClick: this.props.whenClicked },
            this.props.title,
            React.createElement(
                "span",
                { className: "badge" },
...
var Dropdown = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'div',
            { className: 'dropdown' },
            React.createElement(Button, { whenClicked: this.handleClick, className: 'btn-default', title: this.state.itemTitle || this.props.data.title, number: this.props.data.teams.length }),
            React.createElement(List, { teams: this.props.data.teams, display: this.state.display, itemClick: this.handleItemClick, selected: this.state.itemTitle })
        );
    }
});
...
},{"./button":159,"./list":161,"react":158}],161:[function(require,module,exports){
var React = require('react');
...
var List = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            'ul',
            { style: displayStyle, className: 'dropdown-menu' },
            teams
        );
    }
});
...
},{"./team":162,"react":158}],162:[function(require,module,exports){
var React = require('react');
...
var App = React.createClass({
    ...
    render: function () {
        return React.createElement(Dropdown, { data: this.props.data });
    }
});
...
ReactDOM.render(React.createElement(App, { data: data }), document.querySelector('.container'));

},{"./dropdown":160,"react":158,"react-dom":2}]},{},[163]);
